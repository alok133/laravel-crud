                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" action="{{url('/admin/add-blogseo')}}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder="Enter title" required name="meta_title" id="meta_title">
                              </div>
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder="Enter keyword" required name="meta_keyword" id="meta_keyword">
                              </div>
                             
                              
                              <div class="reset-button">
                                
                                <input type="submit" class="btn btn-success" value="add blogseo">
                              </div>
                           </form>
                        </div>
                     </div>
